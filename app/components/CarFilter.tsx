...
import {FactorsProps, formatAge, getDefaultMake, getDefaultModel} from '../types/interfaces';
        ...
        <div>
            <div className='carFilterContainer mt-5' style={{paddingLeft: "10px", paddingRight: "10px"}}>
                <div className='carInnerContainner'>
                    <div
                        className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-1 mt-3">
                        <div className="flex justify-center">
                            <CarSelector jsonData={Makes} defaultWidth={0} setSelected={setMake}
                                         triggerDefault={triggerDefault} defaultValue={getDefaultMake()}
                                         setFilters={setFilters} modelValue={modelValue} setModelValue={setModelValue}/>
                        </div>
                        <div className="flex justify-center">
                            <CarSelector jsonData={filters.Family} defaultWidth={0} setSelected={setModel}
                                         triggerDefault={triggerDefault} defaultValue={getDefaultModel()}
                                         setFilters={setFilters} modelValue={modelValue} setModelValue={setModelValue}/>
                        </div>
                        <div className="flex justify-center">
                            <CarSelector jsonData={filters.Year} defaultWidth={0} setSelected={setYear}
                                         triggerDefault={triggerDefault} defaultValue="" setFilters={setFilters}
                                         modelValue={modelValue} setModelValue={setModelValue}/>
                        </div>
                        <div className="flex justify-center">
                            <CarSelector jsonData={filters.Odometer} defaultWidth={0} setSelected={setOdometer}
                                         triggerDefault={triggerDefault} defaultValue="" setFilters={setFilters}
                                         modelValue={modelValue} setModelValue={setModelValue}/>
                        </div>
                        <div className="flex justify-center">
                            <CarSelector jsonData={filters.AllCarConditions} defaultWidth={0}
                                         setSelected={setVehicleCondition} triggerDefault={triggerDefault}
                                         defaultValue="" setFilters={setFilters} modelValue={modelValue}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-1">
                        ...
                        <div className="flex justify-center">
                            <CarSelector jsonData={filters.BodyTypeConfig} defaultWidth={0}
                                         setSelected={setBodyTypeConfig} triggerDefault={triggerDefault} defaultValue=""
                                         setFilters={setFilters} modelValue={modelValue} setModelValue={setModelValue}/>
                        </div>
                        <div className="flex justify-center">
                        ...
                        <div className="">
                            <input className="flex  descriptionInput descriptionInput560 descriptionInput450"
                                   value={inputValue} onChange={handleInputChange}
                                   placeholder="e.g. Metallic Paint, Power front seats, ..."/>
                        </div>
                ...
                <div className='carControllerInnerContainner'>
                    <div
                        className='grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-3 mt-3 mb-5'>
                        <div className='mt-1'>
                            <a className='flex justify-left showMoreLink showMore560'
            ...
            <div>
                <div
                    className='mt-10 mb-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-5 filterStatistics'>
                    <div
                        className='mt-3 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-5 '>
